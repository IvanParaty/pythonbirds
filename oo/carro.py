...
1) Atribulto de dado velocidade
2) Método acelerar, que deverá incrementar a velocidade de uma unidade
3) Metodo frear, que deverá decrementar a velocidade de duas unidade

A direção terá a responsabilidade de contyrolar a direção. Ela oferece
